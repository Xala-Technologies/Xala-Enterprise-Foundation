...
# Xala Enterprise Foundation - Pre-commit Hook
...
if ! timeout 120 pnpm run test:ci --forceExit --detectOpenHandles --testTimeout=5000 --passWithNoTests --silent >/dev/null 2>&1; then
...
echo "   - Example: 'feat: add NSM classification to health check module'"
echo ""
